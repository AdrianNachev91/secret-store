 ...
 *
 * <p>The native bindings under {@code photos.sluice.secrets} are reachable from inside this module
 * and from nowhere else on the module path. On the classpath this descriptor is ignored for
 * access, and every public type in the jar is reachable.
 *
